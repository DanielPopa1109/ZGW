                ...
                {
                        {
                                ...
                                /*
                                 * Must match IFX_INTERRUPT(ISR_Geth_Tx, CPU_WHICH_SERVICE_ETHERNET,
                                 * ISR_PRIORITY_GETH_TX).  A numeric mismatch routes the DMA TX SRC to
                                 * an unimplemented CPU2 interrupt-vector slot, which executes the
                                 * 0x36-filled PFLASH gap and raises Trap2 ID1.
                                 */
                                .priority                           = ISR_PRIORITY_GETH_TX,
                                .provider                           = IfxSrc_Tos_cpu2,
                        }
                },
                .rxInterrupt =
                {
                        {
                                .channelId                          = IfxGeth_DmaChannel_0,
                                /*
                                 * Must match IFX_INTERRUPT(ISR_Geth_Rx, CPU_WHICH_SERVICE_ETHERNET,
                                 * ISR_PRIORITY_GETH_RX).
                                 */
                                .priority                           = ISR_PRIORITY_GETH_RX,
                                .provider                           = IfxSrc_Tos_cpu2,
                        }
                }
        },
 ...
 * The active netif driver uses g_IfxGeth from lwip_geth_lwip.c. Point the
 * public APP handle at the same object to avoid split/false debugger state.
 */
