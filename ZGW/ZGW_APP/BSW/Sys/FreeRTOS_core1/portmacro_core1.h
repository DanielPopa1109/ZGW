...
#define portASSERT_IF_INTERRUPT_PRIORITY_INVALID_core1()                configASSERT_core1( ( __mfcr( portCPU_ICR_core1 ) & portCPU_ICR_CCPN_MSK_core1 ) <= configMAX_API_CALL_INTERRUPT_PRIORITY_core1 )
