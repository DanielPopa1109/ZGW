...
#define configTOTAL_HEAP_SIZE_core1                      ( ( size_t ) 20000 )
...
#ifdef __TASKING__
#define configASSERT_core1( x_core1 )    if( ( x_core1 ) == 0 ) { }
...
#define configCONTEXT_INTERRUPT_PRIORITY_core1    30
#define configTIMER_INTERRUPT_PRIORITY_core1      31
