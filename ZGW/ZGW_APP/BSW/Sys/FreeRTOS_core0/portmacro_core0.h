...
#define portASSERT_IF_INTERRUPT_PRIORITY_INVALID_core0()                configASSERT_core0( ( __mfcr( portCPU_ICR_core0 ) & portCPU_ICR_CCPN_MSK_core0 ) <= configMAX_API_CALL_INTERRUPT_PRIORITY_core0 )
