...
#define SAFETYKIT_FWCHECK_CLEAR_BIT_20_17   ((uint32)0xFFEDFFFFU)
#define SAFETYKIT_FWCHECK_CLEAR_BIT_20_17_14 ((uint32)0xFFEDBFFFU)
#define SAFETYKIT_FWCHECK_CLEAR_BIT_20_17_14_0 ((uint32)0xFFEDBFFEU)
...
const FwCheckStruct fwCheckSMUTC375DP [] =
{
    ...
    { &SMU_AG7.U,   {0x02,     SAFETYKIT_FWCHECK_CLEAR_BIT_20_17_14_0}, {0x02, SAFETYKIT_FWCHECK_CLEAR_BIT_20_17_14_0}, {0x00000002,   SAFETYKIT_FWCHECK_CLEAR_BIT_20_17_14}, {0x02,     SAFETYKIT_FWCHECK_CLEAR_BIT_20_17}, {0x0,   SAFETYKIT_FWCHECK_CLEAR_BIT_20_17} },/* Standby/application FW-check can complete with ALM7[1] already clear. ALM7[17]/[20] are tolerated for all reset types. ALM7[0]/[14] remain reset-path side effects. */
    { &SMU_AG8.U,   {0x20,     SAFETYKIT_FWCHECK_DEFAULT_MASK}, {0x0,      SAFETYKIT_FWCHECK_CLEAR_BIT_5}, {0x0,    SAFETYKIT_FWCHECK_DEFAULT_MASK}, {0x0,      SAFETYKIT_FWCHECK_DEFAULT_MASK}, {0x20,  SAFETYKIT_FWCHECK_DEFAULT_MASK} },/* Standby/application FW-check on this target reports ALM8[5] set. */
    ...
    { &SMU_AG10.U,  {0x0,      SAFETYKIT_FWCHECK_DEFAULT_MASK}, {0x0,      SAFETYKIT_FWCHECK_CLEAR_BIT_20}, {0x0,    SAFETYKIT_FWCHECK_DEFAULT_MASK}, {0x0,      SAFETYKIT_FWCHECK_DEFAULT_MASK}, {0x0,   SAFETYKIT_FWCHECK_CLEAR_BIT_20} },/* ALM10[20] can be set when AG6[20] is not set after LBIST and is also observed on the standby/application FW-check path. */
...
const MemoryTestedStruct systemSSHTC375DP[] =
{
    ...
    /* TC37x Erratum SCR_TC.022: SCR RAM ECCD can differ after warm reset paths. */
    { IfxMtu_MbistSel_scrXram,          NON_INIT_MEM_TYPE,  NOT_APPLICABLE,     SSH_XRAM_EXCEPTION,     SSH_XRAM_EXCEPTION },
    { IfxMtu_MbistSel_scrIram,          NON_INIT_MEM_TYPE,  NOT_APPLICABLE,     SSH_XRAM_EXCEPTION,     SSH_XRAM_EXCEPTION },
