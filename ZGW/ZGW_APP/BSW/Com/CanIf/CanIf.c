...
static const CanIf_RxPduConfigType CanIf_RxPduConfig[] =
{
    ...
    { CANIF_RX_PDU_CANFD_PDM1_INPUTT30                                     , CAN_CONTROLLER_FD,      0x30Au, CAN_ID_STANDARD, CAN_FRAME_FD,      2u, 2u, CANIF_RX_TARGET_COM },
...
static const CanIf_TxPduConfigType CanIf_TxPduConfig[] =
{
    ...
    { CANIF_TX_PDU_CANFD_ENERGYMANAGEMENTDATA3                             , CAN_HTH_FD,      CAN_CONTROLLER_FD,      0x107u, CAN_ID_STANDARD, CAN_FRAME_FD,      5u, CANIF_TX_TARGET_COM }
};
...
void CanIf_ControllerRecovered(uint8 ControllerId)
{
    ...
    /* CanSM restores the PDU mode for the requested communication mode. */
