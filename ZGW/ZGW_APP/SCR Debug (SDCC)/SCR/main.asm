...
_WCAN_CheckWake_wakeReason_65536_82:
	.ds.b	1
_WCAN_Init_result_65536_88:
	.ds.b	1
_WCAN_Init_TempVar_65536_88:
	.ds.b	1
_main_div_196608_95:
	.ds.b	1
;--------------------------------------------------------
...
;------------------------------------------------------------
;	../SCR/main.c:166: static volatile __xdata uint8 *SCR_TimeAddr(uint8 offset)
;	-----------------------------------------
...
_SCR_TimeAddr:
	...
	movx	@dptr,a
;	../SCR/main.c:168: return (volatile __xdata uint8 *)(SCR_TIME_XRAM_BASE + offset);
	movx	a,@dptr
	mov	r7,a
	mov	r6,#0x00
	mov	a,#0x90
...
;------------------------------------------------------------
;	../SCR/main.c:171: static uint8 SCR_TimeLoadU8(uint8 offset)
;	-----------------------------------------
...
_SCR_TimeLoadU8:
	...
	movx	@dptr,a
;	../SCR/main.c:173: return *SCR_TimeAddr(offset);
	movx	a,@dptr
	mov	dpl,a
	lcall	_SCR_TimeAddr
	movx	a,@dptr
...
;------------------------------------------------------------
;	../SCR/main.c:176: static void SCR_TimeStoreU8(uint8 offset, uint8 value)
;	-----------------------------------------
...
_SCR_TimeStoreU8:
	...
	movx	@dptr,a
;	../SCR/main.c:178: *SCR_TimeAddr(offset) = value;
	movx	a,@dptr
	mov	dpl,a
	lcall	_SCR_TimeAddr
	mov	r6,dpl
...
;------------------------------------------------------------
;	../SCR/main.c:181: static uint32 SCR_TimeLoadU32(uint8 offset)
;	-----------------------------------------
...
_SCR_TimeLoadU32:
	...
	movx	@dptr,a
;	../SCR/main.c:185: value = ((uint32)SCR_TimeLoadU8(offset) << 24);
	movx	a,@dptr
	mov	r7,a
	mov	dpl,a
	push	ar7
...
;	../SCR/main.c:186: value |= ((uint32)SCR_TimeLoadU8((uint8)(offset + 1u)) << 16);
	mov	a,r7
	inc	a
	mov	dpl,a
	push	ar7
...
;	../SCR/main.c:187: value |= ((uint32)SCR_TimeLoadU8((uint8)(offset + 2u)) << 8);
	mov	a,#0x02
	add	a,r7
	mov	dpl,a
	push	ar7
	...
	orl	ar6,a
;	../SCR/main.c:188: value |= (uint32)SCR_TimeLoadU8((uint8)(offset + 3u));
	inc	r7
	inc	r7
	inc	r7
	mov	dpl,r7
...
;------------------------------------------------------------
;	../SCR/main.c:193: static void SCR_TimeStoreU32(uint8 offset, uint32 value)
;	-----------------------------------------
...
_SCR_TimeStoreU32:
	...
	movx	@dptr,a
;	../SCR/main.c:195: SCR_TimeStoreU8(offset, (uint8)(value >> 24));
	movx	a,@dptr
	mov	r7,a
	...
	pop	ar6
	pop	ar7
;	../SCR/main.c:196: SCR_TimeStoreU8((uint8)(offset + 1u), (uint8)(value >> 16));
	mov	a,r7
	inc	a
	mov	r2,a
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	...
	pop	ar6
	pop	ar7
;	../SCR/main.c:197: SCR_TimeStoreU8((uint8)(offset + 2u), (uint8)(value >> 8));
	mov	a,#0x02
	add	a,r7
	mov	r2,a
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	...
	pop	ar6
	pop	ar7
;	../SCR/main.c:198: SCR_TimeStoreU8((uint8)(offset + 3u), (uint8)value);
	inc	r7
	inc	r7
	inc	r7
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
...
;------------------------------------------------------------
;	../SCR/main.c:201: static void SCR_TimeStoreBasePlusElapsedNs( // @suppress("Unused static function")
;	-----------------------------------------
...
_SCR_TimeStoreBasePlusElapsedNs:
	...
	movx	@dptr,a
;	../SCR/main.c:207: SCR_TimeProductLow = (elapsedTicks & 0xFFFFu) * (uint32)SCR_TIME_RTC_TICK_NS; // @suppress("Symbol is not resolved")
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:208: SCR_TimeProductHigh = (elapsedTicks >> 16u) * (uint32)SCR_TIME_RTC_TICK_NS; // @suppress("Symbol is not resolved")
	mov	ar4,r6
	mov	ar5,r7
	mov	r6,#0x00
	mov	r7,#0x00
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:209: SCR_TimeElapsedLow = SCR_TimeProductLow + (SCR_TimeProductHigh << 16u); // @suppress("Symbol is not resolved")
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:210: SCR_TimeElapsedHigh = (SCR_TimeProductHigh >> 16u); // @suppress("Symbol is not resolved")
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:211: if (SCR_TimeElapsedLow < SCR_TimeProductLow) // @suppress("Symbol is not resolved")
	clr	c
	mov	a,r4
	subb	a,r0
	mov	a,r5
	...
	jnc	.00138
.00151:
;	../SCR/main.c:213: SCR_TimeElapsedHigh++; // @suppress("Symbol is not resolved")
	mov	dptr,#_SCR_TimeElapsedHigh
	mov	a,#0x01
	...
	movx	@dptr,a
.00138:
;	../SCR/main.c:216: SCR_TimeCurrentLow = baseLow + SCR_TimeElapsedLow; // @suppress("Symbol is not resolved")
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:217: SCR_TimeCurrentHigh = baseHigh + SCR_TimeElapsedHigh; // @suppress("Symbol is not resolved")
	mov	dptr,#_SCR_TimeElapsedHigh
	movx	a,@dptr
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:218: if (SCR_TimeCurrentLow < baseLow) // @suppress("Symbol is not resolved")
	clr	c
	mov	a,_SCR_TimeStoreBasePlusElapsedNs_sloc0_1_0
	subb	a,r0
	mov	a,(_SCR_TimeStoreBasePlusElapsedNs_sloc0_1_0 + 1)
	...
	jnc	.00140
.00152:
;	../SCR/main.c:220: SCR_TimeCurrentHigh++; // @suppress("Symbol is not resolved")
	mov	dptr,#_SCR_TimeCurrentHigh
	mov	a,#0x01
	add	a,r4
	movx	@dptr,a
	...
	movx	@dptr,a
.00140:
;	../SCR/main.c:223: SCR_TimeStoreU32(offset, SCR_TimeCurrentHigh); // @suppress("Symbol is not resolved")
	mov	dptr,#_SCR_TimeStoreBasePlusElapsedNs_offset_65536_32
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_SCR_TimeCurrentHigh
	...
	pop	ar7
;	../SCR/main.c:224: SCR_TimeStoreU32((uint8)(offset + 4u), SCR_TimeCurrentLow); // @suppress("Symbol is not resolved")
	mov	a,r7
	add	a,#0x04
	mov	r7,a
	mov	dptr,#_SCR_TimeCurrentLow
...
;------------------------------------------------------------
;	../SCR/main.c:239: static uint32 SCR_RtcReadCounter(void) // @suppress("Unused static function")
;	-----------------------------------------
...
.00176:
	sjmp	.00155
.00177:
;	../SCR/main.c:261: (cnt2Before != cnt2After) ||
	mov	dptr,#_SCR_RtcReadCounter_cnt2Before_65536_37
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_SCR_RtcReadCounter_cnt2After_65536_37
...
.00178:
	sjmp	.00155
.00179:
;	../SCR/main.c:262: (cnt1Before != cnt1After));
	mov	dptr,#_SCR_RtcReadCounter_cnt1Before_65536_37
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_SCR_RtcReadCounter_cnt1After_65536_37
...
.00180:
	sjmp	.00155
.00181:
;	../SCR/main.c:267: return (((uint32)cnt3After << 24) |
	mov	r7,#0x00
...
;------------------------------------------------------------
;	../SCR/main.c:281: void SCR_RtcCompareIsr(void) __interrupt(XINTR13) // @suppress("Unused function declaration")
;	-----------------------------------------
...
_SCR_RtcCompareIsr:
	...
	push	psw
	mov	psw,#0x00
;	../SCR/main.c:291: SCR_UNLOCK_PROTECTED_BITS();
	mov	_SCR_PASSWD,#0x98
;	../SCR/main.c:292: SCR_RTC_CON &= (uint8)(~CFRTC_MASK);
	anl	_SCR_RTC_CON,#0xBF
;	../SCR/main.c:293: SCR_RTC_CON &= (uint8)(~RTCC_MASK);
	anl	_SCR_RTC_CON,#0xFE
;	../SCR/main.c:294: SCR_RTC_CNT3 = 0u;
	mov	_SCR_RTC_CNT3,#0x00
;	../SCR/main.c:295: SCR_RTC_CNT2 = 0u;
	mov	_SCR_RTC_CNT2,#0x00
;	../SCR/main.c:296: SCR_RTC_CNT1 = 0u;
	mov	_SCR_RTC_CNT1,#0x00
;	../SCR/main.c:297: SCR_RTC_CNT0 = 0u;
	mov	_SCR_RTC_CNT0,#0x00
;	../SCR/main.c:298: SCR_RTC_CON |= RTCC_MASK;
	orl	_SCR_RTC_CON,#0x01
;	../SCR/main.c:299: SCR_LOCK_PROTECTED_BITS();
	mov	_SCR_PASSWD,#0xA8
;	../SCR/main.c:301: previousLow = SCR_TotalElapsedTicksLow;
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:302: SCR_TotalElapsedTicksLow += (uint32)SCR_TIME_RTC_COMPARE_TICKS;
	mov	dptr,#_SCR_TotalElapsedTicksLow
	mov	a,#0x80
	add	a,r4
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:303: if (SCR_TotalElapsedTicksLow < previousLow)
	mov	dptr,#_SCR_TotalElapsedTicksLow
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	jnc	.00183
.00213:
;	../SCR/main.c:305: SCR_TotalElapsedTicksHigh++;
	...
	movx	@dptr,a
.00183:
;	../SCR/main.c:308: SCR_TimeStoreU32(SCR_TIME_OFFSET_RTC_LAST_TICKS, SCR_TotalElapsedTicksLow);
	mov	dptr,#_SCR_TimeStoreU32_PARM_2
	mov	a,r4
	movx	@dptr,a
	mov	a,r5
	...
	mov	dpl,#0x14
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:309: SCR_TimeStoreU32(SCR_TIME_OFFSET_RTC_LAST_TICKS_HIGH, SCR_TotalElapsedTicksHigh);
	mov	dptr,#_SCR_TotalElapsedTicksHigh
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	dpl,#0x3F
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:310: SCR_TimeStoreU32(SCR_TIME_OFFSET_ELAPSED_TICKS, SCR_TotalElapsedTicksLow);
	mov	dptr,#_SCR_TotalElapsedTicksLow
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	dpl,#0x18
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:311: SCR_TimeStoreU32(SCR_TIME_OFFSET_ELAPSED_TICKS_HIGH, SCR_TotalElapsedTicksHigh);
	mov	dptr,#_SCR_TotalElapsedTicksHigh
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	dpl,#0x3B
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:313: flags = SCR_TimeLoadU8(SCR_TIME_OFFSET_FLAGS);
	mov	dpl,#0x07
	lcall	_SCR_TimeLoadU8
	mov	a,dpl
;	../SCR/main.c:314: if (((flags & SCR_TIME_FLAG_ARMED) != 0u) && (SCR_TimeBaseActive != 0u))
	jb	acc.0,.00214
	ljmp	.00191
.00214:
	...
	ljmp	.00191
.00215:
;	../SCR/main.c:316: previousLow = SCR_TimeBaseUtcLow;
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:317: SCR_TimeBaseUtcLow += (uint32)SCR_TIME_RTC_COMPARE_NS;
	mov	dptr,#_SCR_TimeBaseUtcLow
	mov	a,r4
	movx	@dptr,a
	mov	a,#0xE1
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:318: if (SCR_TimeBaseUtcLow < previousLow)
	mov	dptr,#_SCR_TimeBaseUtcLow
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	jnc	.00185
.00216:
;	../SCR/main.c:320: SCR_TimeBaseUtcHigh++;
	...
	movx	@dptr,a
.00185:
;	../SCR/main.c:323: previousLow = SCR_TimeBaseVehicleLow;
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:324: SCR_TimeBaseVehicleLow += (uint32)SCR_TIME_RTC_COMPARE_NS;
	mov	dptr,#_SCR_TimeBaseVehicleLow
	mov	a,r4
	movx	@dptr,a
	mov	a,#0xE1
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:325: if (SCR_TimeBaseVehicleLow < previousLow)
	mov	dptr,#_SCR_TimeBaseVehicleLow
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	jnc	.00187
.00217:
;	../SCR/main.c:327: SCR_TimeBaseVehicleHigh++;
	...
	movx	@dptr,a
.00187:
;	../SCR/main.c:330: SCR_TimeStoreU32(SCR_TIME_OFFSET_UTC_NS, SCR_TimeBaseUtcHigh);
	mov	dptr,#_SCR_TimeBaseUtcHigh
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	dpl,#0x08
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:331: SCR_TimeStoreU32((uint8)(SCR_TIME_OFFSET_UTC_NS + 4u), SCR_TimeBaseUtcLow);
	mov	dptr,#_SCR_TimeBaseUtcLow
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	dpl,#0x0C
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:332: SCR_TimeStoreU32(SCR_TIME_OFFSET_VEHICLE_NS, SCR_TimeBaseVehicleHigh);
	mov	dptr,#_SCR_TimeBaseVehicleHigh
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	dpl,#0x24
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:333: SCR_TimeStoreU32((uint8)(SCR_TIME_OFFSET_VEHICLE_NS + 4u), SCR_TimeBaseVehicleLow);
	mov	dptr,#_SCR_TimeBaseVehicleLow
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
;------------------------------------------------------------
;	../SCR/main.c:338: static void SCR_TimeInit(void)
;	-----------------------------------------
...
_SCR_TimeInit:
	.using 0
;	../SCR/main.c:342: SCR_TimeBaseActive = 0u;
	mov	dptr,#_SCR_TimeBaseActive
	clr	a
	movx	@dptr,a
;	../SCR/main.c:344: flags = SCR_TimeLoadU8(SCR_TIME_OFFSET_FLAGS);
	mov	dpl,#0x07
	lcall	_SCR_TimeLoadU8
	mov	r7,dpl
;	../SCR/main.c:346: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_INIT_STATUS, SCR_TIME_INIT_STATUS_ENTERED);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,#0x10
	movx	@dptr,a
	mov	dpl,#0x3A
	...
	lcall	_SCR_TimeStoreU8
	pop	ar7
;	../SCR/main.c:347: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_FLAGS_READ, flags);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,r7
	movx	@dptr,a
	mov	dpl,#0x33
	push	ar7
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:348: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_MAGIC0_READ, SCR_TimeLoadU8(SCR_TIME_OFFSET_MAGIC));
	mov	dpl,#0x00
	lcall	_SCR_TimeLoadU8
	mov	r6,dpl
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	...
	mov	dpl,#0x34
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:349: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_MAGIC1_READ, SCR_TimeLoadU8((uint8)(SCR_TIME_OFFSET_MAGIC + 1u)));
	mov	dpl,#0x01
	lcall	_SCR_TimeLoadU8
	mov	r6,dpl
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	...
	mov	dpl,#0x35
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:350: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_MAGIC2_READ, SCR_TimeLoadU8((uint8)(SCR_TIME_OFFSET_MAGIC + 2u)));
	mov	dpl,#0x02
	lcall	_SCR_TimeLoadU8
	mov	r6,dpl
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	...
	mov	dpl,#0x36
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:351: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_MAGIC3_READ, SCR_TimeLoadU8((uint8)(SCR_TIME_OFFSET_MAGIC + 3u)));
	mov	dpl,#0x03
	lcall	_SCR_TimeLoadU8
	mov	r6,dpl
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	...
	mov	dpl,#0x37
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:352: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_VERSION_READ, SCR_TimeLoadU8(SCR_TIME_OFFSET_VERSION));
	mov	dpl,#0x04
	lcall	_SCR_TimeLoadU8
	mov	r6,dpl
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	...
	mov	dpl,#0x38
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:353: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_VALID_READ, SCR_TimeLoadU8(SCR_TIME_OFFSET_VALID));
	mov	dpl,#0x05
	lcall	_SCR_TimeLoadU8
	mov	r6,dpl
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
...
;	../SCR/main.c:358: SCR_UNLOCK_PROTECTED_BITS();
	mov	_SCR_PASSWD,#0x98
;	../SCR/main.c:359: SCR_SCU_PAGE = MOD_PAGE_1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/main.c:360: SCR_SCU_PMCON1 &= (uint8)(~RTC_DIS_MASK);
	anl	_SCR_SCU_PMCON1,#0xFB
;	../SCR/main.c:361: SCR_SCU_DBG_MODSUSP &= (uint8)(~RTCSUSP_MASK);
	anl	_SCR_SCU_DBG_MODSUSP,#0xFD
;	../SCR/main.c:362: SCR_LOCK_PROTECTED_BITS();
	mov	_SCR_PASSWD,#0xA8
;	../SCR/main.c:378: SCR_UNLOCK_PROTECTED_BITS();
	mov	_SCR_PASSWD,#0x98
;	../SCR/scr_rtc_sdcc.h:196: SCR_RTC_CON &= (~RTCC_MASK);
	anl	_SCR_RTC_CON,#0xFE
;	../SCR/main.c:382: SCR_RTC_CON = 0u;
	mov	_SCR_RTC_CON,#0x00
;	../SCR/main.c:383: SCR_RTC_CON = (uint8)(RTCCLKSEL_MASK | RTPBYP_MASK | ECRTC_MASK);
	mov	_SCR_RTC_CON,#0x16
;	../SCR/main.c:385: SCR_RTC_CNT3 = 0u;
	mov	_SCR_RTC_CNT3,#0x00
;	../SCR/main.c:386: SCR_RTC_CNT2 = 0u;
	mov	_SCR_RTC_CNT2,#0x00
;	../SCR/main.c:387: SCR_RTC_CNT1 = 0u;
	mov	_SCR_RTC_CNT1,#0x00
;	../SCR/main.c:388: SCR_RTC_CNT0 = 0u;
	mov	_SCR_RTC_CNT0,#0x00
;	../SCR/main.c:390: SCR_RTC_CR3 = (uint8)((uint32)SCR_TIME_RTC_COMPARE_TICKS >> 24);
	mov	_SCR_RTC_CR3,#0x00
;	../SCR/main.c:391: SCR_RTC_CR2 = (uint8)((uint32)SCR_TIME_RTC_COMPARE_TICKS >> 16);
	mov	_SCR_RTC_CR2,#0x1E
;	../SCR/main.c:392: SCR_RTC_CR1 = (uint8)((uint32)SCR_TIME_RTC_COMPARE_TICKS >> 8);
	mov	_SCR_RTC_CR1,#0x84
;	../SCR/main.c:393: SCR_RTC_CR0 = (uint8)(SCR_TIME_RTC_COMPARE_TICKS);
	mov	_SCR_RTC_CR0,#0x80
;	../SCR/main.c:395: SCR_RTC_CON &= (uint8)(~CFRTC_MASK);
	anl	_SCR_RTC_CON,#0xBF
;	../SCR/main.c:397: SCR_LOCK_PROTECTED_BITS();
	mov	_SCR_PASSWD,#0xA8
;	../SCR/main.c:399: if (SCR_TimeLoadU32(SCR_TIME_OFFSET_MAGIC) != SCR_TIME_MAGIC)
	mov	dpl,#0x00
	...
	sjmp	.00228
.00256:
;	../SCR/main.c:401: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_INIT_STATUS, SCR_TIME_INIT_STATUS_MAGIC_FAIL);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,#0xE1
	movx	@dptr,a
	mov	dpl,#0x3A
	...
	ljmp	.00229
.00228:
;	../SCR/main.c:403: else if (SCR_TimeLoadU8(SCR_TIME_OFFSET_VERSION) != SCR_TIME_VERSION)
	mov	dpl,#0x04
	push	ar7
	lcall	_SCR_TimeLoadU8
	mov	r6,dpl
	...
	sjmp	.00225
.00257:
;	../SCR/main.c:405: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_INIT_STATUS, SCR_TIME_INIT_STATUS_VERSION_FAIL);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,#0xE2
	movx	@dptr,a
	mov	dpl,#0x3A
	...
	ljmp	.00229
.00225:
;	../SCR/main.c:407: else if (SCR_TimeLoadU8(SCR_TIME_OFFSET_VALID) != SCR_TIME_VALID)
	mov	dpl,#0x05
	push	ar7
	lcall	_SCR_TimeLoadU8
	mov	r6,dpl
	...
	sjmp	.00222
.00258:
;	../SCR/main.c:409: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_INIT_STATUS, SCR_TIME_INIT_STATUS_VALID_FAIL);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,#0xE3
	movx	@dptr,a
	mov	dpl,#0x3A
	...
	ljmp	.00229
.00222:
;	../SCR/main.c:411: else if ((flags & SCR_TIME_FLAG_ARMED) == 0u)
	mov	a,r7
	jb	acc.0,.00219
.00259:
;	../SCR/main.c:413: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_INIT_STATUS, SCR_TIME_INIT_STATUS_ARMED_FAIL);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,#0xE4
	movx	@dptr,a
	mov	dpl,#0x3A
	...
	ljmp	.00229
.00219:
;	../SCR/main.c:417: SCR_TimeBaseUtcHigh = SCR_TimeLoadU32(SCR_TIME_OFFSET_UTC_NS); // @suppress("Symbol is not resolved")
	mov	dpl,#0x08
	lcall	_SCR_TimeLoadU32
	mov	r4,dpl
	mov	r5,dph
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:418: SCR_TimeBaseUtcLow = SCR_TimeLoadU32((uint8)(SCR_TIME_OFFSET_UTC_NS + 4u)); // @suppress("Symbol is not resolved")
	mov	dpl,#0x0C
	lcall	_SCR_TimeLoadU32
	mov	r4,dpl
	mov	r5,dph
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:419: SCR_TimeBaseVehicleHigh = SCR_TimeLoadU32(SCR_TIME_OFFSET_VEHICLE_NS); // @suppress("Symbol is not resolved")
	mov	dpl,#0x24
	lcall	_SCR_TimeLoadU32
	mov	r4,dpl
	mov	r5,dph
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:420: SCR_TimeBaseVehicleLow = SCR_TimeLoadU32((uint8)(SCR_TIME_OFFSET_VEHICLE_NS + 4u)); // @suppress("Symbol is not resolved")
	mov	dpl,#0x28
	lcall	_SCR_TimeLoadU32
	mov	r4,dpl
	mov	r5,dph
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:422: SCR_TimeBaseActive = 1u;
	mov	dptr,#_SCR_TimeBaseActive
	mov	a,#0x01
	movx	@dptr,a
;	../SCR/main.c:425: SCR_TotalElapsedTicksLow = 0u; // @suppress("Symbol is not resolved")
	mov	dptr,#_SCR_TotalElapsedTicksLow
	clr	a
	movx	@dptr,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:426: SCR_TotalElapsedTicksHigh = 0u; // @suppress("Symbol is not resolved")
	mov	dptr,#_SCR_TotalElapsedTicksHigh
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	../SCR/main.c:432: SCR_TimeStoreU32(SCR_TIME_OFFSET_RTC_START_TICKS, 0u);
	mov	dptr,#_SCR_TimeStoreU32_PARM_2
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	...
	mov	dpl,#0x10
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:433: SCR_TimeStoreU32(SCR_TIME_OFFSET_RTC_LAST_TICKS, 0u);
	mov	dptr,#_SCR_TimeStoreU32_PARM_2
	clr	a
	movx	@dptr,a
	inc	dptr
	...
	mov	dpl,#0x14
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:434: SCR_TimeStoreU32(SCR_TIME_OFFSET_ELAPSED_TICKS, 0u);
	mov	dptr,#_SCR_TimeStoreU32_PARM_2
	clr	a
	movx	@dptr,a
	inc	dptr
	...
	mov	dpl,#0x18
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:435: SCR_TimeStoreU32(SCR_TIME_OFFSET_RTC_LAST_TICKS_HIGH, 0u);
	mov	dptr,#_SCR_TimeStoreU32_PARM_2
	clr	a
	movx	@dptr,a
	inc	dptr
	...
	mov	dpl,#0x3F
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:436: SCR_TimeStoreU32(SCR_TIME_OFFSET_ELAPSED_TICKS_HIGH, 0u);
	mov	dptr,#_SCR_TimeStoreU32_PARM_2
	clr	a
	movx	@dptr,a
	inc	dptr
	...
	mov	dpl,#0x3B
	lcall	_SCR_TimeStoreU32
;	../SCR/main.c:437: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_INIT_STATUS, SCR_TIME_INIT_STATUS_ACTIVE);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,#0xA5
	movx	@dptr,a
	mov	dpl,#0x3A
	lcall	_SCR_TimeStoreU8
.00229:
;	../SCR/main.c:444: SCR_UNLOCK_PROTECTED_BITS();
	mov	_SCR_PASSWD,#0x98
;	../SCR/scr_rtc_sdcc.h:191: SCR_RTC_CON |= RTCC_MASK;
	orl	_SCR_RTC_CON,#0x01
;	../SCR/main.c:446: SCR_LOCK_PROTECTED_BITS();
	mov	_SCR_PASSWD,#0xA8
;	../SCR/main.c:449: if (SCR_TimeBaseActive != 0u)
	mov	dptr,#_SCR_TimeBaseActive
	movx	a,@dptr
	jz	.00231
.00260:
;	../SCR/main.c:451: SCR_IEN1 |= (uint8)(1u << 7u);  /* IEN1.ECCIP3: enable XINTR13 RTC */
	orl	_SCR_IEN1,#0x80
;	../SCR/main.c:452: SCR_IEN0_EA = 1u;               /* global interrupt enable */
;	assignBit
	setb	_SCR_IEN0_EA
.00231:
;	../SCR/main.c:456: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_RTC_CON, SCR_RTC_CON);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,_SCR_RTC_CON
	movx	@dptr,a
	mov	dpl,#0x2C
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:458: SCR_SCU_PAGE = MOD_PAGE_1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/main.c:459: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_PMCON1, SCR_SCU_PMCON1);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,_SCR_SCU_PMCON1
	movx	@dptr,a
	mov	dpl,#0x2D
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:460: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_TIME_ACTIVE, SCR_TimeBaseActive);
	mov	dptr,#_SCR_TimeBaseActive
	movx	a,@dptr
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	movx	@dptr,a
...
;------------------------------------------------------------
;	../SCR/main.c:463: static void SCR_TimeUpdate(void)
;	-----------------------------------------
...
_SCR_TimeUpdate:
	.using 0
;	../SCR/main.c:472: *G_BOOT_STAGE_ADDR = BOOT_STAGE_TIME_UPDATE_ENTRY;
;	../SCR/main.c:483: *G_BOOT_STAGE_ADDR = BOOT_STAGE_TIME_COUNTER_READ;
	mov	dptr,#0x1769
	mov	a,#0x50
	movx	@dptr,a
	inc	a
	movx	@dptr,a
;	../SCR/main.c:488: *G_BOOT_STAGE_ADDR = BOOT_STAGE_TIME_TICKS_STORED;
	mov	dptr,#0x1769
	inc	a
	movx	@dptr,a
;	../SCR/main.c:491: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_RTC_CON,   SCR_RTC_CON);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,_SCR_RTC_CON
	movx	@dptr,a
	mov	dpl,#0x2C
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:492: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_RTC_CNT0,  SCR_RTC_CNT0);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,_SCR_RTC_CNT0
	movx	@dptr,a
	mov	dpl,#0x2E
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:493: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_RTC_CNT1,  SCR_RTC_CNT1);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,_SCR_RTC_CNT1
	movx	@dptr,a
	mov	dpl,#0x2F
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:494: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_RTC_CNT2,  SCR_RTC_CNT2);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,_SCR_RTC_CNT2
	movx	@dptr,a
	mov	dpl,#0x30
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:495: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_RTC_CNT3,  SCR_RTC_CNT3);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,_SCR_RTC_CNT3
	movx	@dptr,a
	mov	dpl,#0x31
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:496: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_TIME_ACTIVE, SCR_TimeBaseActive);
	mov	dptr,#_SCR_TimeBaseActive
	movx	a,@dptr
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	movx	@dptr,a
	mov	dpl,#0x32
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:498: flags = SCR_TimeLoadU8(SCR_TIME_OFFSET_FLAGS);
	mov	dpl,#0x07
	lcall	_SCR_TimeLoadU8
	mov	r7,dpl
;	../SCR/main.c:499: SCR_TimeStoreU8(SCR_TIME_OFFSET_DEBUG_FLAGS_READ, flags);
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	mov	a,r7
	movx	@dptr,a
	mov	dpl,#0x33
	...
	lcall	_SCR_TimeStoreU8
	pop	ar7
;	../SCR/main.c:500: *G_BOOT_STAGE_ADDR = BOOT_STAGE_TIME_FLAGS_READ;
	mov	dptr,#0x1769
	mov	a,#0x53
	movx	@dptr,a
;	../SCR/main.c:501: if ((flags & SCR_TIME_FLAG_ARMED) != 0u)
	mov	a,r7
	jnb	acc.0,.00264
.00275:
;	../SCR/main.c:503: (*d1)++;
	...
	mov	a,r7
	movx	@dptr,a
;	../SCR/main.c:511: if (SCR_TimeBaseActive != 0u)
	mov	dptr,#_SCR_TimeBaseActive
	movx	a,@dptr
	jz	.00264
.00276:
;	../SCR/main.c:513: (*d2)++;
	...
	movx	@dptr,a
.00264:
;	../SCR/main.c:529: *G_BOOT_STAGE_ADDR = BOOT_STAGE_TIME_UPDATE_DONE;
	mov	dptr,#0x1769
	mov	a,#0x56
	movx	@dptr,a
.00265:
...
;------------------------------------------------------------
;	../SCR/main.c:532: static uint8 WCAN_WaitForSelectiveWakeAck(uint8 expected)
;	-----------------------------------------
...
_WCAN_WaitForSelectiveWakeAck:
	...
	movx	@dptr,a
;	../SCR/main.c:536: SCR_WCAN_PAGE = MOD_PAGE_1;
	mov	_SCR_WCAN_PAGE,#0x01
;	../SCR/main.c:538: while(((SCR_WCAN_INTESTAT0 & WCAN_STATUS0_SWACK_MASK) != expected) && (timeout > 0u))
	movx	a,@dptr
	mov	r7,a
	mov	r5,#0xFF
	mov	r6,#0xFF
...
.00304:
	sjmp	.00278
.00280:
;	../SCR/main.c:543: return (timeout > 0u) ? 1u : 0u;
	mov	a,r5
	orl	a,r6
	jz	.00283
.00305:
...
;------------------------------------------------------------
;	../SCR/main.c:546: static void WCAN_ClearEvents(void)
;	-----------------------------------------
...
_WCAN_ClearEvents:
	.using 0
;	../SCR/main.c:548: SCR_WCAN_PAGE = MOD_PAGE_1;
	mov	_SCR_WCAN_PAGE,#0x01
;	../SCR/main.c:549: SCR_WCAN_INTESCLR0 = WCAN_STATUS0_CLEAR_MASK;
	mov	_SCR_WCAN_INTESCLR0,#0xFC
;	../SCR/main.c:550: SCR_WCAN_INTESCLR1 = WCAN_STATUS1_CLEAR_MASK;
...
;------------------------------------------------------------
;	../SCR/main.c:553: static void SCR_RequestStandbyWake(uint8 wakeReason)
;	-----------------------------------------
...
_SCR_RequestStandbyWake:
	...
	movx	@dptr,a
;	../SCR/main.c:557: combinedWakeReason = (uint8)(*G_WAKE_REASON_ADDR | wakeReason);
	mov	dptr,#0x1765
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_SCR_RequestStandbyWake_wakeReason_65536_68
	...
	mov	r6,a
	orl	ar7,a
;	../SCR/main.c:558: *G_WAKE_REASON_ADDR = combinedWakeReason;
	mov	dptr,#0x1765
	mov	a,r7
	movx	@dptr,a
;	../SCR/main.c:561: (uint8)(SCR_TimeLoadU8(SCR_TIME_OFFSET_WAKE_REASON) | wakeReason));
	mov	dpl,#0x20
	push	ar6
	lcall	_SCR_TimeLoadU8
	mov	a,dpl
	...
	mov	dpl,#0x20
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:563: SCR_SCU_PAGE = MOD_PAGE_1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/main.c:565: WCANWKSEL_MASK | WDTWKSEL_MASK | ECCWKSEL_MASK | SCRWKP_MASK);
...
;------------------------------------------------------------
;	../SCR/main.c:568: static void SCR_ConfigureFaultWake(void)
;	-----------------------------------------
...
_SCR_ConfigureFaultWake:
	.using 0
;	../SCR/main.c:570: SCR_SCU_PAGE = MOD_PAGE_1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/main.c:571: SCR_SCU_PMCON1 &= (uint8)(~WDT_DIS_MASK);
	anl	_SCR_SCU_PMCON1,#0xEF
;	../SCR/main.c:572: SCR_SCU_RSTCON &= (uint8)(~(ECCRSTEN_MASK | WDTRSTEN_MASK));
	anl	_SCR_SCU_RSTCON,#0xFC
;	../SCR/main.c:573: SCR_SCU_NMISR = SCR_FAULT_NMISR_MASK;
	mov	_SCR_SCU_NMISR,#0x03
;	../SCR/main.c:575: SCR_NMICON_WDT_MASK | SCR_NMICON_RAMECC_MASK | SCR_NMICON_WAKE_MASK);
	orl	_SCR_SCU_NMICON,#0x43
;	../SCR/main.c:577: WCANWKSEL_MASK | WDTWKSEL_MASK | ECCWKSEL_MASK);
	orl	_SCR_SCU_STDBYWKP,#0x1C
;	../SCR/main.c:579: SCR_WDT_REL = SCR_WDT_RELOAD_100MS;
	mov	_SCR_WDT_REL,#0xC3
;	../SCR/main.c:580: SCR_WDT_WINB = 0u;
	mov	_SCR_WDT_WINB,#0x00
;	../SCR/main.c:581: SCR_WDT_CON = (uint8)(WDTIN_MASK | WDTRS_MASK | WDTEN_MASK);
...
;------------------------------------------------------------
;	../SCR/main.c:584: static void SCR_WatchdogService(void)
;	-----------------------------------------
...
_SCR_WatchdogService:
	.using 0
;	../SCR/main.c:589: SCR_WDT_CON = (uint8)(SCR_WDT_CON | WDTRS_MASK);
...
;------------------------------------------------------------
;	../SCR/main.c:595: static void SCR_CheckFaultWake(void)
;	-----------------------------------------
...
.00337:
.00314:
;	../SCR/main.c:608: faultStatus |= SCR_FAULT_STATUS_ECC_DBE;
	mov	dptr,#_SCR_CheckFaultWake_faultStatus_65536_75
	mov	a,#0x01
	movx	@dptr,a
;	../SCR/main.c:609: wakeReason |= SCR_FAULT_REASON_ECC_DBE;
	mov	dptr,#_SCR_CheckFaultWake_wakeReason_65536_75
	mov	a,#0x20
	movx	@dptr,a
.00315:
;	../SCR/main.c:612: if (((nmiStatus & 0x01u) != 0u) || ((rstStatus & WDTRST_MASK) != 0u))
	mov	dptr,#_SCR_CheckFaultWake_nmiStatus_65536_75
	movx	a,@dptr
	jb	acc.0,.00317
.00338:
...
.00339:
.00317:
;	../SCR/main.c:614: faultStatus |= SCR_FAULT_STATUS_WDT;
	mov	dptr,#_SCR_CheckFaultWake_faultStatus_65536_75
	movx	a,@dptr
	orl	acc,#0x02
	movx	@dptr,a
;	../SCR/main.c:615: wakeReason |= SCR_FAULT_REASON_WDT;
	mov	dptr,#_SCR_CheckFaultWake_wakeReason_65536_75
	movx	a,@dptr
	orl	acc,#0x40
	movx	@dptr,a
.00318:
;	../SCR/main.c:618: if (faultStatus != 0u)
	mov	dptr,#_SCR_CheckFaultWake_faultStatus_65536_75
	movx	a,@dptr
	mov	r7,a
	movx	a,@dptr
	jz	.00322
.00340:
;	../SCR/main.c:622: (uint8)(SCR_TimeLoadU8(SCR_TIME_OFFSET_SCR_FAULT_STATUS) | faultStatus));
	mov	dpl,#0x21
	push	ar7
	lcall	_SCR_TimeLoadU8
	mov	a,dpl
	...
	mov	dpl,#0x21
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:623: SCR_TimeStoreU8(SCR_TIME_OFFSET_SCR_NMI_STATUS, nmiStatus);
	mov	dptr,#_SCR_CheckFaultWake_nmiStatus_65536_75
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	...
	push	ar7
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:624: SCR_TimeStoreU8(SCR_TIME_OFFSET_SCR_RST_STATUS, rstStatus);
	mov	dptr,#_SCR_CheckFaultWake_rstStatus_65536_75
	movx	a,@dptr
	mov	r6,a
	mov	dptr,#_SCR_TimeStoreU8_PARM_2
	...
	push	ar6
	lcall	_SCR_TimeStoreU8
;	../SCR/main.c:625: SCR_RequestStandbyWake(wakeReason);
	mov	dptr,#_SCR_CheckFaultWake_wakeReason_65536_75
	movx	a,@dptr
	mov	dpl,a
	...
	pop	ar6
	pop	ar7
;	../SCR/main.c:627: SCR_SCU_PAGE = MOD_PAGE_1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/main.c:628: SCR_SCU_NMISR = (uint8)(nmiStatus & SCR_FAULT_NMISR_MASK);
	mov	a,#0x03
	anl	a,r7
	mov	_SCR_SCU_NMISR,a
;	../SCR/main.c:629: SCR_SCU_RSTST = (uint8)(rstStatus & SCR_FAULT_RSTST_MASK);
	mov	a,#0x03
	anl	a,r6
...
;------------------------------------------------------------
;	../SCR/main.c:633: static void WCAN_ConfigureWakeFrame(void)
;	-----------------------------------------
...
_WCAN_ConfigureWakeFrame:
	.using 0
;	../SCR/main.c:635: SCR_WCAN_PAGE = MOD_PAGE_2;
	mov	_SCR_WCAN_PAGE,#0x02
;	../SCR/main.c:636: SCR_WCAN_ID0_CTRL = 0x00u;
	mov	_SCR_WCAN_ID0_CTRL,#0x00
;	../SCR/main.c:637: SCR_WCAN_ID1_CTRL = 0x00u;
	mov	_SCR_WCAN_ID1_CTRL,#0x00
;	../SCR/main.c:638: SCR_WCAN_ID2_CTRL = WCAN_WAKE_ID2_VALUE;
	mov	_SCR_WCAN_ID2_CTRL,#0x40
;	../SCR/main.c:639: SCR_WCAN_ID3_CTRL = WCAN_WAKE_ID3_VALUE;
	mov	_SCR_WCAN_ID3_CTRL,#0x04
;	../SCR/main.c:640: SCR_WCAN_MASK_ID0_CTRL = 0xFFu;
	mov	_SCR_WCAN_MASK_ID0_CTRL,#0xFF
;	../SCR/main.c:641: SCR_WCAN_MASK_ID1_CTRL = 0xFFu;
	mov	_SCR_WCAN_MASK_ID1_CTRL,#0xFF
;	../SCR/main.c:642: SCR_WCAN_MASK_ID2_CTRL = WCAN_WAKE_ID2_MASK;
	mov	_SCR_WCAN_MASK_ID2_CTRL,#0xF3
;	../SCR/main.c:643: SCR_WCAN_MASK_ID3_CTRL = WCAN_WAKE_ID3_MASK;
	mov	_SCR_WCAN_MASK_ID3_CTRL,#0x5D
;	../SCR/main.c:645: SCR_WCAN_PAGE = MOD_PAGE_3;
	mov	_SCR_WCAN_PAGE,#0x03
;	../SCR/main.c:646: SCR_WCAN_DATA0_CTRL = 0xFFu;
	mov	_SCR_WCAN_DATA0_CTRL,#0xFF
;	../SCR/main.c:647: SCR_WCAN_DATA1_CTRL = 0xFFu;
	mov	_SCR_WCAN_DATA1_CTRL,#0xFF
;	../SCR/main.c:648: SCR_WCAN_DATA2_CTRL = 0xFFu;
	mov	_SCR_WCAN_DATA2_CTRL,#0xFF
;	../SCR/main.c:649: SCR_WCAN_DATA3_CTRL = 0xFFu;
	mov	_SCR_WCAN_DATA3_CTRL,#0xFF
;	../SCR/main.c:650: SCR_WCAN_DATA4_CTRL = 0xFFu;
	mov	_SCR_WCAN_DATA4_CTRL,#0xFF
;	../SCR/main.c:651: SCR_WCAN_DATA5_CTRL = 0xFFu;
	mov	_SCR_WCAN_DATA5_CTRL,#0xFF
;	../SCR/main.c:652: SCR_WCAN_DATA6_CTRL = 0xFFu;
	mov	_SCR_WCAN_DATA6_CTRL,#0xFF
;	../SCR/main.c:653: SCR_WCAN_DATA7_CTRL = 0xFFu;
...
;------------------------------------------------------------
;	../SCR/main.c:656: static void WCAN_CheckWake(void)
;	-----------------------------------------
...
_WCAN_CheckWake:
	.using 0
;	../SCR/main.c:661: uint8 wakeReason = 0u;
	mov	dptr,#_WCAN_CheckWake_wakeReason_65536_82
	clr	a
	movx	@dptr,a
;	../SCR/main.c:663: SCR_WCAN_PAGE = MOD_PAGE_1;
	mov	_SCR_WCAN_PAGE,#0x01
;	../SCR/main.c:664: wcanStatus0 = SCR_WCAN_INTESTAT0;
	mov	dptr,#_WCAN_CheckWake_wcanStatus0_65536_82
	mov	a,_SCR_WCAN_INTESTAT0
	movx	@dptr,a
;	../SCR/main.c:665: wcanStatus1 = SCR_WCAN_INTESTAT1;
	mov	dptr,#_WCAN_CheckWake_wcanStatus1_65536_82
	mov	a,_SCR_WCAN_INTESTAT1
	movx	@dptr,a
;	../SCR/main.c:667: SCR_IO_PAGE = MOD_PAGE_0;
	mov	_SCR_IO_PAGE,#0x00
;	../SCR/main.c:668: p00In = SCR_IO_P00_IN;
	mov	dptr,#_WCAN_CheckWake_p00In_65536_82
	mov	a,_SCR_IO_P00_IN
	movx	@dptr,a
;	../SCR/main.c:670: *G_WCAN_STAT0_ADDR = wcanStatus0;
	mov	dptr,#_WCAN_CheckWake_wcanStatus0_65536_82
	movx	a,@dptr
	mov	dptr,#0x1761
	movx	@dptr,a
;	../SCR/main.c:671: *G_WCAN_STAT1_ADDR = wcanStatus1;
	mov	dptr,#_WCAN_CheckWake_wcanStatus1_65536_82
	movx	a,@dptr
	mov	dptr,#0x1762
	movx	@dptr,a
;	../SCR/main.c:672: *G_P00_IN_ADDR = p00In;
	mov	dptr,#_WCAN_CheckWake_p00In_65536_82
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#0x1763
	movx	@dptr,a
;	../SCR/main.c:674: SCR_SCU_PAGE = MOD_PAGE_1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/main.c:675: *G_STDBYWKP_ADDR = SCR_SCU_STDBYWKP;
	mov	dptr,#0x1767
	mov	a,_SCR_SCU_STDBYWKP
	movx	@dptr,a
;	../SCR/main.c:677: if((p00In & CANFD_RXD_PIN_MASK) == 0u)
	mov	a,r7
	jb	acc.5,.00344
.00371:
;	../SCR/main.c:679: (*G_RX_LOW_COUNT_ADDR)++;
	mov	dptr,#0x1764
	movx	a,@dptr
	mov	r7,a
	inc	r7
	...
	movx	@dptr,a
.00344:
;	../SCR/main.c:682: if((wcanStatus1 & WCAN_STATUS1_WUF_MASK) != 0u)
	mov	dptr,#_WCAN_CheckWake_wcanStatus1_65536_82
	movx	a,@dptr
	mov	r7,a
	jnb	acc.0,.00347
.00372:
;	../SCR/main.c:684: wakeReason = WCAN_WAKE_REASON_WUF;
	mov	dptr,#_WCAN_CheckWake_wakeReason_65536_82
	mov	a,#0x01
	movx	@dptr,a
;	../SCR/main.c:695: else if((WCAN_WAKE_ON_SYNC_FRAME != 0u) && ((wcanStatus1 & WCAN_STATUS1_SYNC_MASK) != 0u))
	sjmp	.00350
.00347:
	mov	a,r7
	jnb	acc.1,.00350
.00373:
;	../SCR/main.c:697: wakeReason = WCAN_WAKE_REASON_SYNC;
	mov	dptr,#_WCAN_CheckWake_wakeReason_65536_82
	mov	a,#0x02
	movx	@dptr,a
.00350:
;	../SCR/main.c:701: if(wakeReason != 0u)
	mov	dptr,#_WCAN_CheckWake_wakeReason_65536_82
	movx	a,@dptr
	mov	r7,a
	movx	a,@dptr
	jz	.00353
.00374:
;	../SCR/main.c:703: SCR_RequestStandbyWake(wakeReason);
	mov	dpl,r7
	lcall	_SCR_RequestStandbyWake
.00353:
;	../SCR/main.c:705: }
...
;------------------------------------------------------------
;result                    Allocated with name '_WCAN_Init_result_65536_88'
;TempVar                   Allocated with name '_WCAN_Init_TempVar_65536_88'
;------------------------------------------------------------
;	../SCR/main.c:707: char WCAN_Init(void)
;	-----------------------------------------
;	 function WCAN_Init
;	-----------------------------------------
...
_WCAN_Init:
	.using 0
;	../SCR/main.c:709: char result = 0;
	mov	dptr,#_WCAN_Init_result_65536_88
	clr	a
	movx	@dptr,a
;	../SCR/main.c:710: unsigned char volatile TempVar = 0;
	mov	dptr,#_WCAN_Init_TempVar_65536_88
	movx	@dptr,a
;	../SCR/main.c:712: *G_BOOT_STAGE_ADDR = BOOT_STAGE_WCAN_INIT_ENTRY;
	mov	dptr,#0x1769
	mov	a,#0x21
	movx	@dptr,a
;	../SCR/main.c:720: SCR_IO_PAGE = 0x1;
	mov	_SCR_IO_PAGE,#0x01
;	../SCR/main.c:722: SCR_IO_P00_IOCR5 = ScrPortMode_inputPullUp; // WCANRXDD(P33.5 / SCR_P00.5)
	mov	_SCR_IO_P00_IOCR5,#0x10
;	../SCR/main.c:724: SCR_IO_PAGE = 0x2;
	mov	_SCR_IO_PAGE,#0x02
;	../SCR/main.c:725: SCR_IO_P00_PDISC = 0xDF ; // WCANRXDD(P33.5 / SCR_P00.5)
	mov	_SCR_IO_P00_PDISC,#0xDF
;	../SCR/main.c:726: *G_BOOT_STAGE_ADDR = BOOT_STAGE_WCAN_PIN_CFG;
	mov	dptr,#0x1769
	inc	a
	movx	@dptr,a
;	../SCR/main.c:728: SCR_SCU_PAGE = 0x1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/main.c:729: SCR_SCU_RSTCON = 0x0 ; // Disable WDT and ECC reset
	mov	_SCR_SCU_RSTCON,#0x00
;	../SCR/main.c:730: SCR_SCU_STDBYWKP = (uint8)(WCANWKSEL_MASK | WDTWKSEL_MASK | ECCWKSEL_MASK);
	mov	_SCR_SCU_STDBYWKP,#0x1C
;	../SCR/main.c:731: *G_BOOT_STAGE_ADDR = BOOT_STAGE_WCAN_WAKE_CFG;
	mov	dptr,#0x1769
	inc	a
	movx	@dptr,a
;	../SCR/main.c:749: SCR_SCU_PAGE = 1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/main.c:750: SCR_SCU_PMCON1 &= ~(1<< 3); // enable WCAN clock (bit_3), default: WCAN is disabled
	anl	_SCR_SCU_PMCON1,#0xF7
;	../SCR/main.c:751: *G_BOOT_STAGE_ADDR = BOOT_STAGE_WCAN_CLOCK_ENABLED;
	mov	dptr,#0x1769
	mov	a,#0x24
	movx	@dptr,a
;	../SCR/main.c:753: SCR_SCU_PAGE = 0x2;
	mov	_SCR_SCU_PAGE,#0x02
;	../SCR/main.c:754: TempVar = SCR_SCU_MODPISEL0 & MaskWCANRXDIS; // Mask WCAN bits
	mov	a,_SCR_SCU_MODPISEL0
	mov	dptr,#_WCAN_Init_TempVar_65536_88
	anl	a,#0x0F
	movx	@dptr,a
;	../SCR/main.c:755: SCR_SCU_MODPISEL0 = TempVar | (SetWCANRXDD<<4); // Enable CAN on P33.5
	movx	a,@dptr
	orl	a,#0x30
	mov	_SCR_SCU_MODPISEL0,a
;	../SCR/main.c:756: *G_BOOT_STAGE_ADDR = BOOT_STAGE_WCAN_PIN_SELECTED;
	mov	dptr,#0x1769
	mov	a,#0x25
	movx	@dptr,a
;	../SCR/main.c:758: SCR_WCAN_PAGE = 0x0 ;
	mov	_SCR_WCAN_PAGE,#0x00
;	../SCR/main.c:759: SCR_WCAN_CFG = WCAN_CFG_CCE | WCAN_CFG_WCAN_EN; // CCE=1, SELWK_EN=0, WCAN_EN=1 --> according to UM
	mov	_SCR_WCAN_CFG,#0x09
;	../SCR/main.c:760: SCR_WCAN_INTMRSLT = WCAN_INT_ENABLE_WUF_ONLY;
	mov	_SCR_WCAN_INTMRSLT,#0x04
;	../SCR/main.c:761: SCR_WCAN_FD_CTRL = 0x00 ; // Classic CAN wake path
	mov	_SCR_WCAN_FD_CTRL,#0x00
;	../SCR/main.c:762: *G_BOOT_STAGE_ADDR = BOOT_STAGE_WCAN_CFG_WRITTEN;
	mov	dptr,#0x1769
	inc	a
	movx	@dptr,a
;	../SCR/main.c:767: SCR_WCAN_PAGE = 0x1;
	mov	_SCR_WCAN_PAGE,#0x01
;	../SCR/main.c:768: SCR_WCAN_FRMERRCNT = 0x00u;
	mov	_SCR_WCAN_FRMERRCNT,#0x00
;	../SCR/main.c:769: SCR_WCAN_DLC_CTRL = WCAN_WAKE_DLC_VALUE ; // 8 bytes of wake data
	mov	_SCR_WCAN_DLC_CTRL,#0x00
;	../SCR/main.c:770: SCR_WCAN_BTL1_CTRL = 0x64 ; // Configure classic CAN Baud Rate of 500 kbit/s
	mov	_SCR_WCAN_BTL1_CTRL,#0x64
;	../SCR/main.c:771: SCR_WCAN_BTL2_CTRL = (1<<6) | (0x33<<0) ; // BRP=01(Divide by 2) and SP=0x33 represents ~80%SP
	mov	_SCR_WCAN_BTL2_CTRL,#0x73
;	../SCR/main.c:772: WCAN_ClearEvents();
	lcall	_WCAN_ClearEvents
;	../SCR/main.c:773: *G_BOOT_STAGE_ADDR = BOOT_STAGE_WCAN_BITTIMING;
	mov	dptr,#0x1769
	mov	a,#0x27
	movx	@dptr,a
;	../SCR/main.c:779: SCR_WCAN_PAGE = 0x0 ;
	mov	_SCR_WCAN_PAGE,#0x00
;	../SCR/main.c:780: SCR_WCAN_INTMRSLT = WCAN_INT_ENABLE_WUF_ONLY;
	mov	_SCR_WCAN_INTMRSLT,#0x04
;	../SCR/main.c:781: SCR_WCAN_CFG &= ~(WCAN_CFG_CCE | WCAN_CFG_SELWK_EN); // CCE=0, SELWK_EN=0, WCAN_EN remains enabled
	anl	_SCR_WCAN_CFG,#0xF3
;	../SCR/main.c:783: if(WCAN_WaitForSelectiveWakeAck(0u) == 0u)
	mov	dpl,#0x00
	lcall	_WCAN_WaitForSelectiveWakeAck
	mov	a,dpl
	jnz	.00376
.00389:
;	../SCR/main.c:785: result |= WCAN_INIT_SWACK_CLEAR_TIMEOUT;
	mov	dptr,#_WCAN_Init_result_65536_88
	mov	a,#0x01
	movx	@dptr,a
.00376:
;	../SCR/main.c:787: *G_BOOT_STAGE_ADDR = BOOT_STAGE_SWACK_CLEAR_DONE;
	mov	dptr,#0x1769
	mov	a,#0x28
	movx	@dptr,a
;	../SCR/main.c:789: WCAN_ConfigureWakeFrame();
	lcall	_WCAN_ConfigureWakeFrame
;	../SCR/main.c:790: *G_BOOT_STAGE_ADDR = BOOT_STAGE_WUF_CFG_DONE;
	mov	dptr,#0x1769
	mov	a,#0x29
	movx	@dptr,a
;	../SCR/main.c:792: WCAN_ClearEvents();
	lcall	_WCAN_ClearEvents
;	../SCR/main.c:794: SCR_WCAN_PAGE = MOD_PAGE_0;
	mov	_SCR_WCAN_PAGE,#0x00
;	../SCR/main.c:795: SCR_WCAN_CFG |= WCAN_CFG_SELWK_EN;
	orl	_SCR_WCAN_CFG,#0x04
;	../SCR/main.c:797: if(WCAN_WaitForSelectiveWakeAck(WCAN_STATUS0_SWACK_MASK) == 0u)
	mov	dpl,#0x01
	lcall	_WCAN_WaitForSelectiveWakeAck
	mov	a,dpl
	jnz	.00378
.00390:
;	../SCR/main.c:799: result |= WCAN_INIT_SWACK_SET_TIMEOUT;
	mov	dptr,#_WCAN_Init_result_65536_88
	movx	a,@dptr
	orl	acc,#0x02
	movx	@dptr,a
.00378:
;	../SCR/main.c:801: *G_BOOT_STAGE_ADDR = BOOT_STAGE_SWACK_SET_DONE;
	mov	dptr,#0x1769
	mov	a,#0x2A
	movx	@dptr,a
;	../SCR/main.c:803: WCAN_ClearEvents();
	lcall	_WCAN_ClearEvents
;	../SCR/main.c:804: SCR_WCAN_PAGE = MOD_PAGE_1;
	mov	_SCR_WCAN_PAGE,#0x01
;	../SCR/main.c:805: *G_FDF_BASELINE_ADDR = (SCR_WCAN_INTESTAT1 & WCAN_STATUS1_FDF_MASK);
	mov	a,_SCR_WCAN_INTESTAT1
	anl	a,#0x10
	mov	dptr,#0x1768
	movx	@dptr,a
;	../SCR/main.c:806: *G_WCAN_INIT_ADDR = (uint8)result;
	mov	dptr,#_WCAN_Init_result_65536_88
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#0x1766
	movx	@dptr,a
;	../SCR/main.c:807: *G_BOOT_STAGE_ADDR = BOOT_STAGE_WCAN_INIT_DONE;
	mov	dptr,#0x1769
	mov	a,#0x2B
	movx	@dptr,a
;	../SCR/main.c:809: return result;
	mov	dpl,r7
.00379:
;	../SCR/main.c:810: }
	ret
...
;------------------------------------------------------------
;__1310720213              Allocated with name '_main___1310720213_131072_94'
;div                       Allocated with name '_main_div_196608_95'
;------------------------------------------------------------
;	../SCR/main.c:812: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
...
_main:
	.using 0
;	../SCR/main.c:814: *G_COUNTER_ADDR = 0u;
	mov	dptr,#0x1760
	clr	a
	movx	@dptr,a
;	../SCR/main.c:815: *G_WCAN_STAT0_ADDR = 0u;
	mov	dptr,#0x1761
	movx	@dptr,a
;	../SCR/main.c:816: *G_WCAN_STAT1_ADDR = 0u;
	mov	dptr,#0x1762
	movx	@dptr,a
;	../SCR/main.c:817: *G_P00_IN_ADDR = 0u;
	mov	dptr,#0x1763
	movx	@dptr,a
;	../SCR/main.c:818: *G_RX_LOW_COUNT_ADDR = 0u;
	mov	dptr,#0x1764
	movx	@dptr,a
;	../SCR/main.c:819: *G_WAKE_REASON_ADDR = 0u;
	mov	dptr,#0x1765
	movx	@dptr,a
;	../SCR/main.c:820: *G_WCAN_INIT_ADDR = 0u;
	mov	dptr,#0x1766
	movx	@dptr,a
;	../SCR/main.c:821: *G_STDBYWKP_ADDR = 0u;
	mov	dptr,#0x1767
	movx	@dptr,a
;	../SCR/main.c:822: *G_FDF_BASELINE_ADDR = 0u;
	mov	dptr,#0x1768
	movx	@dptr,a
;	../SCR/main.c:823: *G_BOOT_STAGE_ADDR = BOOT_STAGE_MAIN_ENTRY;
	mov	dptr,#0x1769
	mov	a,#0x11
	movx	@dptr,a
;	../SCR/scr_common.h:63: SCR_UNLOCK_PROTECTED_BITS();          /* Open access to write protected bits  */
...
;	../SCR/scr_common.h:72: SCR_LOCK_PROTECTED_BITS();            /* Close access to write protected bits */
	mov	_SCR_PASSWD,#0xA8
;	../SCR/main.c:825: *G_BOOT_STAGE_ADDR = BOOT_STAGE_CLOCK_SET;
	mov	dptr,#0x1769
	inc	a
	movx	@dptr,a
;	../SCR/main.c:826: SCR_TimeInit();
	lcall	_SCR_TimeInit
;	../SCR/main.c:827: WCAN_Init();
	lcall	_WCAN_Init
;	../SCR/main.c:828: SCR_ConfigureFaultWake();
	lcall	_SCR_ConfigureFaultWake
;	../SCR/main.c:830: while(1)
.00392:
;	../SCR/main.c:832: *G_BOOT_STAGE_ADDR = BOOT_STAGE_LOOP_RUNNING;
	mov	dptr,#0x1769
	mov	a,#0x40
	movx	@dptr,a
;	../SCR/main.c:833: SCR_TimeUpdate();
	lcall	_SCR_TimeUpdate
;	../SCR/main.c:834: *G_BOOT_STAGE_ADDR = BOOT_STAGE_LOOP_TIME_DONE;
	mov	dptr,#0x1769
	mov	a,#0x41
	movx	@dptr,a
;	../SCR/main.c:835: SCR_CheckFaultWake();
	lcall	_SCR_CheckFaultWake
;	../SCR/main.c:836: *G_BOOT_STAGE_ADDR = BOOT_STAGE_LOOP_FAULT_DONE;
	mov	dptr,#0x1769
	mov	a,#0x42
	movx	@dptr,a
;	../SCR/main.c:837: SCR_WatchdogService();
	lcall	_SCR_WatchdogService
;	../SCR/main.c:838: *G_BOOT_STAGE_ADDR = BOOT_STAGE_LOOP_WDT_DONE;
	mov	dptr,#0x1769
	mov	a,#0x43
	movx	@dptr,a
;	../SCR/main.c:839: WCAN_CheckWake();
	lcall	_WCAN_CheckWake
;	../SCR/main.c:840: *G_BOOT_STAGE_ADDR = BOOT_STAGE_LOOP_WCAN_DONE;
	mov	dptr,#0x1769
	mov	a,#0x44
	movx	@dptr,a
;	../SCR/main.c:841: (*G_COUNTER_ADDR)++;
	mov	dptr,#0x1760
	movx	a,@dptr
	mov	r7,a
	inc	r7
